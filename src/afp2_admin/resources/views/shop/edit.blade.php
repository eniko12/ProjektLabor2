                            ...
                            <form method="post" action="{{ route('books.update') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ISBN" name="ISBN"
                                           placeholder="Enter ISBN" required="required" value="{{ $book->ISBN }}">
                                    @error("ISBN")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           class="form-control"
                                           id="title" name="title"
                                           placeholder="Enter title" required="required" value="{{ $book->title }}">@error("title")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="thumbnail"
                                           name="thumbnail"
                                           placeholder="Enter thumbnail"  required="required"  value="{{ $book->thumbnail }}">@error("thumbnail")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1900" max="2099" step="1" value="2020"
                                           ...
                                           id="publish_year"
                                           name="publish_year"
                                           placeholder="Enter publish_year"  required="required"  value="{{ $book->publish_year }}">@error("publish_year")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="language"
                                           name="language"
                                           placeholder="Enter language"  required="required"  value="{{ $book->language }}">@error("language")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="99999" step="1" value="100"
                                           ...
                                           id="page_count"
                                           name="page_count"
                                           placeholder="Enter page_count" required="required"  value="{{ $book->page_count }}">@error("page_count")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="description"
                                           name="description"
                                           placeholder="Enter description" required="required"  value="{{ $book->description }}">@error("description")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox"
                                           ...
                                           name="can_preorder"
                                           checked="checked"
                                           placeholder="Enter can_preorder"  value="{{ $book->can_preorder }}">@error("can_preorder")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" max="99999" step="1" value="100"
                                           ...
                                           name="in_stock"
                                           required="required"
                                           placeholder="Enter in_stock"  value="{{ $book->in_stock }}">@error("in_stock")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           class="form-control"
                                           id="price" name="price"
                                           placeholder="Enter price"  value="{{ $book->price }}">@error("price")
